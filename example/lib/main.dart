...
import 'TIMUIKitCreateGroupExample.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  int getSDKAPPID() {
    return const int.fromEnvironment('SDK_APPID', defaultValue:1600054407 );
  }

  String getUserID() {
    return const String.fromEnvironment('LOGINUSERID', defaultValue: "16870023");
  }

  String getSecret() {
    return const String.fromEnvironment('SECRET', defaultValue: "16870023");
  }

  String getUsersig() {
    return const String.fromEnvironment('USERSIG', defaultValue: "eJwtjM0KgkAURt9l1mHX2*TMCC0KZmV-VBRBG2lGuYU1qYgVvXsyuvzOOXxfdljug8aWLGYYABv5TcY*asrI4zCSAgAng6vMPXWODIvDCACmnIPojW0dlbbjAiVAz2oqPOHYpSiHsqK8O1brha3b5*m10Z9kfjRarhLV6GyrcnzfVOqwuIaXsdg17jxjvz-vljDc");
  }
  ...
  initTIMUIKIT() async {
    ...
    timCoreInstance.setTheme(theme: const TUITheme(
        ...
        weakDividerColor: Color(0xFF000000),
        conversationItemChooseBgColor: Color(0xFF000000),
        wideBackgroundColor: Color(0xFF999999),
        appbarBgColor: Color(0xFF000000),
        conversationItemBgColor: Color(0xFF000000),
        weakTextColor: Color(0xFFFAFAFB),
        white: Color(0xFF000000),
        appbarTextColor:Colors.white,
        black: Color(0xFFFFFFFF),
        darkTextColor: Color(0xFFFFFFFF),
        conversationItemTitleTextColor: Color(0xFFFFFFFF),
        textColor: Color.fromARGB(255, 54, 47, 35)));
  ...
  getAPIWidget(String apiName) {
    switch (apiName) {
      ...
      case 'Timuikitcreategroupexample':
        return const Timuikitcreategroupexample();
    }
  }
